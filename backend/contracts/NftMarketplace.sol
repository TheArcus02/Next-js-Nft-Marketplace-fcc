...
contract NftMarketplace {
    ...
    // NFT contract address => token id => Listing price
     ...
     * @dev We could make contract hold nft but this way people can
     * have therir nft in their wallet when listed.
     */
    function listItem(
        address nftAddress,
        uint256 tokenId,
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        // Give aproval to marketplace to have access to user NFT
        IERC721 nft = IERC721(nftAddress);
